...
- Safe acceptance STL: one selection reaches `exact` mode, displays a real WebGL wireframe/exploded viewport in a consistent reflected display frame, and provides all five downloads.
