...
2026-09-05 的 2.5D 孔洞包含計算優化，在同主機 Node 暖身後五次量測中，將兩個參考模型的轉換中位數分別降低 27.9% 及 26.4%；幾何及六種輸出內容一致。這是轉換階段的比較，不含 ZIP/PDF 封裝時間，詳見 [2.5D 優化驗證](docs/validation/2026-09-05-projected-optimization.md)。
