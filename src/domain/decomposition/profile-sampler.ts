...
export function sampleLathedProfile(mesh: TriangleMesh, axis: Axis, binCount = 64): LathedProfile {
  if (!axis.confirmed) throw new DecompositionError('PROFILE', 'Axis must be confirmed');
